<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="?act=addcolor" enctype="multipart/form-data" method="post">
                <div class="mb-3 mt-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pwd" placeholder="Tên" name="name" required>
                </div>
                <div class="mb-3 mt-3">
                    <label for="email" class="form-label">Màu</label>
                     <input type="color" class="form-control" id="pwd" name="color" >
