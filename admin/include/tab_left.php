        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon ">
                    ...
                    <img src="../public/admin/img/logoo.jpg" alt="logo" class="img-profile rounded-circle" width="65">
                </div>
                <div class="sidebar-brand-text mx-3">TrendyCleat </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="?act=slsanpham">Thống Kê</a>
                    </div>
                </div>
            </li>
            <!-- size -->
            <li class="nav-item">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="?act=slsize">Thống Kê</a>
                    </div>
                </div>
            </li>
            <!-- color -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Chức năng:</h6>
                        <a class="collapse-item" href="?act=donhang">Danh Sách</a>
                        <a class="collapse-item" href="?act=sldanhmuc">Thống Kê</a>
                    </div>
                </div>
            </li>
