...
<head>
  ...
  <!--== Pe7 Stroke Icon CSS ==-->
  <link href="../public/user/assets/css/pe-icon-7-stroke.css" rel="stylesheet" />
  <!--== Swiper CSS ==-->
  <link href="../public/user/assets/css/swiper.min.css" rel="stylesheet" />
  <!--== Fancybox Min CSS ==-->
  <link href="../public/user/assets/css/fancybox.min.css" rel="stylesheet" />
  <!--== Aos Min CSS ==-->
  <link href="../public/user/assets/css/aos.min.css" rel="stylesheet" />
                ...
                <div class="header-navigation-area position-relative">
                  <ul class="main-menu nav">
                    ...
                    <li class="has-submenu"><a href="#/"><span>Account</span></a>
                      <ul class="submenu-nav">
                        <li><a href="index.php?act=taikhoan"><span>Account</span></a></li>
