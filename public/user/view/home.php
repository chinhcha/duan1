    ...
    <div class="swiper-container home-slider-container default-slider-container">
      <div class="swiper-wrapper home-slider-wrapper slider-default">
        <div class="swiper-slide">
          <div class="slider-content-area" data-bg-img="assets/img/shape/background.png">
            <div class="container">
                  ...
                  <div class="col-sm-6 col-md-5">
                    <div class="slider-content">
                      <div class="content">
                        ...
                        <!-- <div class="desc-box">
                              <p class="desc">Man's Shoes TrendyCleat</p>
                            </div> -->
                        <div class="btn-box">
                          <a class="btn-slider" href="index.php?act=trangsp">Shop Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="slider-thumb">
                      ...
                      <div class="shape-group mousemove">
                        ...
                        <div class="shape-group-two scene"><span class="scene-layer" data-depth=".6"><img src="assets/img/shape/3.webp" width="471" height="462" alt="Image-HasTech"></span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <h2 class="slider-text-shape">HOT 2023</h2>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="slider-content-area" data-bg-img="assets/img/shape/background.png">
          ...
          <div class="product-collection">
            <div class="inner-content">
              <div class="product-collection-content">
                <div class="content">
                  <h3 class="title"><a href="index.php?act=trangsp">Sports Shoes</a></h3>
              ...
              <div class="inner-content">
                <div class="product-thumb">
                  ...
                  <div class="product-action">
                    ...
                    <a class="btn-product-compare" href="index.php?act=trangsp"><i class="fa fa-random"></i></a>
                  </div>
                  <a class="banner-link-overlay" href="index.php?act=trangsp"></a>
                </div>
                <div class="product-info">
                  ...
                  <div class="prices">
                    <span class="price-old"><?= $sp['gia'] ?></span>
                    <span class="sep">-</span>
      ...
      <div class="row divider-wrap divider-style1">
        <div class="col-lg-6">
          <div class="divider-content" data-title="NEW">
            ...
            <a class="btn-theme" href="index.php?act=trangsp">Shop Now</a>
          </div>
        </div>
      </div>
    </div>
    <div class="bg-layer-wrap">
      <div class="bg-layer-style z-index--1 parallax" data-speed="1.05" data-bg-img="assets/img/photos/bg1.webp">
      </div>
      <div class="bg-layer-style z-index--1 parallax" data-speed="1.05" data-bg-img="assets/img/photos/bg1.webp" style="background-image: none;" data-jarallax-original-styles="background-image: url(&quot;assets/img/photos/bg1.webp&quot;);">
        <div id="jarallax-container-0" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; z-index: -100;">
          <div style="background-position: 50% 50%; background-size: cover; background-repeat: no-repeat; background-image: url(&quot;https://template.hasthemes.com/shome/shome/assets/img/photos/bg1.webp&quot;); position: absolute; top: 0px; left: 0px; width: 744.6px; height: 543.04px; overflow: hidden; pointer-events: none; margin-top: -26.02px; transform: translate3d(0px, -8.34124px, 0px);">
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="product-item">
                      <div class="inner-content">
                        <div class="product-thumb">
                          ...
                          <div class="product-action">
                            <a class="btn-product-wishlist" href="shop-wishlist.html"><i class="fa fa-heart"></i></a>
                            <a class="btn-product-cart" href="index.php?act=cart&id_sp=<?= $sp['id_sp'] ?>"><i class="fa fa-shopping-cart"></i></a>
                            <button type="button" class="btn-product-quick-view-open">
                              <i class="fa fa-arrows"></i>
                            </button>
                        ...
                        <div class="product-info">
                          <div class="category">
                            <ul>
                              <li><a href="index.php?act=trangsp?>">Men</a></li>
                          </div>
                          <h4 class="title"><a href="index.php?act=chitietsp&id_sp=<?= $sp['id_sp'] ?>"><?= $sp['name_sp'] ?></a></h4>
                          <div class="prices">
                            <span class="price-old"><?= $sp['gia'] ?></span>
