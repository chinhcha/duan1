                ...
                <div class="product-single-thumb">
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <a class="lightbox-image" data-fancybox="gallery" href="./public/uploads/<?= $hinh['img_url'] ?>">
                          <img src="./public/uploads/<?= $hinh['img_url'] ?>" width="570" height="541" alt="Image-HasTech">
                        </a>
                      </div> 
                      <?php } ?>
                      <!--
                  ...
                  <div class="swiper-container single-product-nav single-product-nav-slider">
                    <div class="swiper-wrapper">
                       ...
                       <div class="swiper-slide">
                          <img src="./public/uploads/<?= $hinh['img_url'] ?>" width="127" height="127" alt="Image-HasTech">
                        </div>
                        <?php } ?>
                        <!--
                        <div class="swiper-slide">
              ...
              <div class="col-xl-6">
                ...
                <div class="product-single-info">
                  ...
                  <div class="product-quick-action">
                    ...
                    <a class="btn-theme" data-id="<?= $sp['id_sp']?>" onclick="addToCart(<?=$sp['id_sp']?>, '<?= $sp['name_sp']?>', <?= $sp['gia']?>)">Add to Cart</a>
                  </div>
